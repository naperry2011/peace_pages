...
export default function LibraryPage() {
  ...
  return (
    <div className="py-8 px-6 md:px-10 bg-gray-50 min-h-screen">
      <div className="container mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Book Library</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredBooks.length > 0 ? (
            filteredBooks.map(book => (
              <div key={book.id} className="bg-white rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105">
                ...
                <div className="p-4">
                  ...
                  <Link href={`/book/${book.id}`} className="block text-center text-white bg-indigo-600 rounded-md py-2 hover:bg-indigo-700 transition-colors">
                    View Book
                  </Link>
                </div>
              </div>
            ...
            <div className="col-span-full text-center py-12">
              <p className="text-gray-500 text-lg">No books match your filters. Try adjusting your criteria.</p>
            </div>
          )}
        </div>
      </div>
